...
vehicle_details = """<p>un vehículo de la exclusiva propiedad de la PARTE VENDEDORA, el referido vehículo tiene las siguientes características:
...
PLACA DEL VEHÍCULO: <span data-placeholder="25">[Placa]</span>.</p>"""
...
efectivo = "<p>los cuales recibe la PARTE VENDEDORA en este acto, de manos de la PARTE COMPRADORA en dinero en efectivo."
...
final_clause = """<p>Con el otorgamiento de este documento hago la tradición legal al comprador del bien vendido. La PARTE COMPRADORA, arriba identificada, declara: Que acepta la venta que se le hace y en los términos anteriormente expuestos. En la ciudad de su presentación, a la fecha de su otorgamiento.
<span data-placeholder="2">[Firma del Vendedor]</span>
<span data-placeholder="18">[Firma del Comprador]</span></p>"""
