...
vehicle_details = ("<p>un vehículo de la exclusiva propiedad de la PARTE VENDEDORA, el referido vehículo tiene las siguientes "
"características:</p><p>CLASE: <span data-placeholder='31'>[Clase]</span>;</p><p>MODELO: <span data-placeholder='24'>[Modelo]</span>;</p>"
"<p>MARCA: <span data-placeholder='23'>[Marca]</span>;</p><p>AÑO: <span data-placeholder='28'>[Año]</span>;</p><p>COLOR: "
"<span data-placeholder='30'>[Color]</span>;</p><p>USO: <span data-placeholder='32'>[Uso]</span>;</p><p>TIPO: "
"<span data-placeholder='29'>[Tipo]</span>;</p><p>SERIAL DEL MOTOR: <span data-placeholder='26'>[Serial del Motor]</span>;</p>"
"<p>SERIAL DE CARROCERÍA: <span data-placeholder='27'>[Serial de Carrocería]</span>;</p><p>PLACA DEL VEHÍCULO: "
